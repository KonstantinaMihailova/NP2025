...
interface LogProcessor<T extends ILog & Comparable<T>> {
    ArrayList<T> proccesLogs(ArrayList<T> logs);
}
...
//TODO constructor
    ...
    void printResults() {
       ...
       //TODO define concrete log processors with lambda expressions
        ...
        firstLogProcessor.proccesLogs(logsList).forEach(l -> System.out.println(l.toString()));

        System.out.println("RESULTS FROM THE SECOND LOG PROCESSOR");
        secondLogProcessor.proccesLogs(logsList).forEach(l -> System.out.println(l.toString()));

        System.out.println("RESULTS FROM THE THIRD LOG PROCESSOR");
        thirdLogProcessor.proccesLogs(logsList).forEach(l -> System.out.println(l.toString()));
